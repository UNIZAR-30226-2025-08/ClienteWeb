export const roles = [
  {
    ...
    nombre: "Aldeano",
    descripcion:
      "No posee ningún poder especial, aparte de su intuición y su sentido común",
  ...
  },
  {
    ...
    nombre: "Cazador",
    descripcion:
      "Cuando muera, puede elegir a otro jugador a quien matar. La decisión es únicamente suya y no se debe tomar por consenso ni consejo.",
    equipo: "Bando de los aldeanos",
  },
  {
    ...
    nombre: "Hombre Lobo",
    descripcion:
      "Por la noche, designarán una víctima que será devorada. Debe haber unanimidad en la designación de la víctima o, en caso contrario, no habrá víctima esa noche.",
  ...
  },
  {
    ...
    nombre: "Vidente",
    descripcion:
      "Todas las noches elige un jugador para revelar su correspondiente carta de personaje y descubrir su rol. La carta de dicho jugador es únicamente mostrada a la vidente.",
    equipo: "Bando de los aldeanos",
  },
  {
